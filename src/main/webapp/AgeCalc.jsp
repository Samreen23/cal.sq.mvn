...
<button class="tablink" onclick="openPage('SimpleCalculator', this, '#FFC0CB')" >Simple Calculator</button>
<button class="tablink" onclick="openPage('AgeCalculator', this, '#FFC0CB')" id="defaultOpen">Age Calculator</button>
